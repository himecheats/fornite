...
//#define ItemDefinition2 0x20// public ItemDefinition info;
...
//
//// hooks
//#define oGetSkinColor 0x40E560 // internal Color GetSkinColor(float skinNumber) { } класс SkinSet
//#define oSetSkinColor 0x737550 // private void SetSkinColor(Color skinColor) { }
//#define oSetFlying 0x1E3F7C0  //public void set_flying(bool value) { } 
//#define oSendProjectileAttack 0x475510 // public void SendProjectileAttack(PlayerProjectileAttack attack) { }
//#define oCanAttack 0x45BC10  // public bool CanAttack() { }
//#define oCreateProjectile 0x6CBBE0 // private Projectile CreateProjectile(string prefabPath, Vector3 pos, Vector3 forward, Vector3 velocity) { } (2)
//#define oBlockSprint 0x45B000 // public virtual void BlockSprint(float duration = 0,2) { }
//#define oGetSpeed 0x466830 // public float GetSpeed(float running, float ducking) { }
//#define oGetIndexedSpreadScalar 0x8AD230 // public float GetIndexedSpreadScalar(int shotIndex, int maxShots) { }
//#define oAntiAim 0x474E50 //internal void SendClientTick() { }
//#define oFakeCard 0x55C750  //public int get_accessLevel() { }
//#define oAimConeUtil 0x785FD0  //public static Vector3 GetModifiedAimConeDirection(float aimCone, Vector3 inputVec, bool anywhereInside = True) { }
//#define oClientInput 0x346D80  //public virtual void ClientInput(InputState state, ModelState modelState) { }
//#define oTodSky 0xC3E280 // public T GetComponent() { } ?
//#define oClosestPoint 0x2139750  //public Vector3 ClosestPoint(Vector3 position) { }
//#define oDoorKnock 0x8C5120  //public void Menu_KnockDoor(BasePlayer player) { }
//#define oServerRPC 0x6C0120  //public void ServerRPC(string funcName) { }
//#define oAmbientMode 0x1868D10//// public static void set_ambientMode(AmbientMode value) { }
//#define oambientIntensit 0x1868C50 //public static void set_ambientIntensity(float value) { }
//#define oambientLight 0x1868CD0 //public static void set_ambientLight(Color value) { }
//#define oRun 0x214D070 //public static string Run(ConsoleSystem.Option options, string strCommand, object[] args) { } //ConsoleSystem$$Run // ConsoleSystem$$Run //scripts.json

// hooks script 
#define oBaseNetworkable 0x329B028 //BN Class$BaseNetworkable BaseNetworkable_c*
//#define oSlideWalk 0x90D120 // PlayerWalkMovement$$HandleRunning // private void HandleRunning(ModelState state, bool wantsRun) { }
